...
1. Clone this repository:
   ```sh
   git clone https://github.com/ShrivatsaSK/Medicine_management.git
...
## Contact
For any issues, please create an issue in the repository or reach out to `kulkarnishrivatsa05@gmail.com`.
